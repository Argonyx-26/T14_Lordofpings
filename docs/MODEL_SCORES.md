...
| Signal reduction | 314 raw events → 20 siloed alerts → **3 incidents** (99 % fewer than raw; 1,242 before phones were reduced to per-area counts) | same 30 min, 6 cameras + door sensors + GPS | `metrics.json` |
